...
$query = "SELECT nama_mobil, foto_mobil, harga_per_hari FROM mobil";
        ...
        <div class="cars-container">
            ...
            <div class="car-card">
                ...
                <ul class="car-features">
                    <li><i class="icon"><svg width="24" height="24" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <li><i class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24">
                                <path
                    ...
                    <li><i class="icon"><svg width="24px" height="24px" viewBox="0 0 24 24" fill="none"
            ...
            <!-- You can duplicate this block to create multiple car listings -->
            <!-- Example with more cards -->
            <div class="car-card">
            ...
            <div class="car-card">
                <img src="../Asset/hput 1.png" alt="Toyota Hilux">
                <h4>Toyota Hilux</h4>
                <p>Rp 390.000</p>
                <p>2023</p>
                <ul class="car-features">
            ...
            <div class="car-card">
                <img src="../Asset/palisadenb.png" alt="Hyundai Palisade">
            ...
            <!-- Repeat this structure for all car listings -->
        </div>
    </section>
